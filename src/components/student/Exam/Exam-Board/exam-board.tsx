...
import { mockedExamBoardData as examBoardData } from '@/mocks/mockedExamData';
import ExamBoardHeader from './exam-board-header';
import ExamBoardTable from './exam-board-table';
...
const statusColor = {
    Correct: 'bg-mintGreen text-forestGreen',
    Wrong: 'bg-deepMaroonRed text-rosewater',
};

export default function ExamBoard() {
    return (
        <div className="max-w-5xl h-[449px] border border-ironSlateBlue rounded-xl bg-shadowNavyBlue overflow-hidden">
            <ExamBoardHeader />
            <ExamBoardTable data={examBoardData} />
        </div>
    );
}

...
export default function RegistrationCompletedCard({ onReview }: { onReview: () => void }) {
    return (
        <div className="flex flex-col items-center justify-center bg-slateBlack w-[419px] h-[399.36px] rounded-[20.95px] shadow-lg p-8">
            <div className="flex items-center justify-center mb-8 w-[170px] h-[170px] rounded-full bg-warmOrange">
                <Check className="w-[125.7px] h-[125.7px] text-slateBlack" />
            </div>
            ...
            <div className="flex gap-4">
                <Button
                    onClick={onReview}
                    variant="outline"
                    className="text-white border-white rounded-[8px] w-[160px] h-[42px] font-semibold text-[16px] font-poppins"
                >
                    Review
                </Button>
                <Button
